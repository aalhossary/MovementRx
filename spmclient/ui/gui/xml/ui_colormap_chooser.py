...
class Ui_colorMapChooser(object):
    def setupUi(self, colorMapChooser):
        ...
        self.formLayout.setWidget(15, QtWidgets.QFormLayout.FieldRole, self.threecomp_colormap_name_comboBox)
        ...
        self.threecomp_max_value_spinbox.valueChanged['int'].connect(colorMapChooser.update_legend)
    ...
    def retranslateUi(self, colorMapChooser):
        ...
        self.label_7.setText(_translate("colorMapChooser", "Individual components"))
        ...
        self.label_12.setText(_translate("colorMapChooser", "3D Componets Legend Colors"))
